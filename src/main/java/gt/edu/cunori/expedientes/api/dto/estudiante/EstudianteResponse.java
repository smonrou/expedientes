...
public class EstudianteResponse {
    ...
    public String getTipoSangreNombre() { return tipoSangreNombre; }
    public void setTipoSangreNombre(String tipoSangreNombre) { this.tipoSangreNombre = tipoSangreNombre; }

    public List<EstudianteSubDtos.TelefonoResponse> getTelefonos() { return telefonos; }
    public void setTelefonos(List<EstudianteSubDtos.TelefonoResponse> telefonos) { this.telefonos = telefonos; }

    public List<EstudianteSubDtos.CondicionMedicaResponse> getCondicionesMedicas() { return condicionesMedicas; }
    public void setCondicionesMedicas(List<EstudianteSubDtos.CondicionMedicaResponse> condicionesMedicas) { this.condicionesMedicas = condicionesMedicas; }

    public List<EstudianteSubDtos.AlergiaResponse> getAlergias() { return alergias; }
    public void setAlergias(List<EstudianteSubDtos.AlergiaResponse> alergias) { this.alergias = alergias; }

    public List<EstudianteSubDtos.DiscapacidadResponse> getDiscapacidades() { return discapacidades; }
    public void setDiscapacidades(List<EstudianteSubDtos.DiscapacidadResponse> discapacidades) { this.discapacidades = discapacidades; }

    public List<EstudianteSubDtos.ContactoEmergenciaResponse> getContactosEmergencia() { return contactosEmergencia; }
    public void setContactosEmergencia(List<EstudianteSubDtos.ContactoEmergenciaResponse> contactosEmergencia) { this.contactosEmergencia = contactosEmergencia; }
}