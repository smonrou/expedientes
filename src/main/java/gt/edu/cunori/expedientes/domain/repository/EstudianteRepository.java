...
public interface EstudianteRepository extends JpaRepository<Estudiante, Long> {
    ...
    boolean existsByCarne(String carne);
    ...
    @Query("""
            ...
            WHERE LOWER(u.nombre)   LIKE LOWER(CONCAT('%', :termino, '%'))
               ...
               OR LOWER(e.carne)    LIKE LOWER(CONCAT('%', :termino, '%'))
            """)
    List<Estudiante> buscarPorTermino(@Param("termino") String termino);

    /**
     * Busca estudiantes de una carrera específica que coincidan con el término de búsqueda.
    ...
    @Query("""
            ...
            WHERE e.carrera.id = :carreraId
              AND (LOWER(u.nombre)   LIKE LOWER(CONCAT('%', :termino, '%'))
               ...
               OR  LOWER(e.carne)    LIKE LOWER(CONCAT('%', :termino, '%')))
            """)
    List<Estudiante> buscarPorTerminoYCarrera(@Param("termino") String termino,
